...
\bibitem{bagirov}
Bagirov, A.M. and Rubinov, A.M. (2000), Global minimization of increasing positively homogeneous functions over the unit simplex, {\it Annals of Operations Research} 98(1-4), 171-187.

\bibitem{bomze}
Bomze, I.M. and de Klerk, E. (2002). Solving standard quadratic optimization problems via linear, semidefinite and copositive programming, {\it Journal of Global Optimization} 24(2), 163-185.

\bibitem{deklerk_survey}
de Klerk, E. (2008). The complexity of optimizing over a simplex, hypercube or sphere: a short survey, {\it Central European Journal of Operations Research} 16(2), 111-125.

\bibitem{deklerk}
de Klerk, E., Den Hertog, D. and Elabwabi, G. (2008). On the complexity of optimization over the standard simplex, {\it European journal of operational research} 191(3), 773-785.

\bibitem{deklerk_poly}
de Klerk, E., Laurent, M. and Parrilo, P.A. (2006). A PTAS for the minimization of polynomials of fixed degree over the simplex, {\it Theoretical Computer Science} 361(2-3), 210-225.

\bibitem{deklerk_alternative}
de Klerk, E., Laurent, M. and Sun, Z. (2015). An alternative proof of a PTAS for fixed-degree polynomial optimization over the simplex, {\it Mathematical Programming} 151(2), 433-457.

\bibitem{direct}
Jones, D.R., Perttunen, C.D. and Stuckman, B.E. (1993). Lipschitzian optimization without the Lipschitz constant, {\it Journal of Optimization Theory and Applications} 79(1), 157-181.

\bibitem{disimpl}
Paulavi$\breve{\mbox{c}}$ius, R. and $\breve{\mbox{Z}}$ilinskas, J. (2014). Simplicial Lipschitz Optimization Without Lipschitz Constant, In {\it Simplicial Global Optimization}, 61-86. Springer New York.

\bibitem{pinter}
Pint$\acute{\mbox{e}}$r, J.D. (1996). {\it Global Optimization in Action}, Kluwer Academic Publishers, Volume 6.

\bibitem{rubinov}
Rubinov, A. and Andramonov, M. (1999). Lipschitz programming via increasing convex-along-rays functions, {\it Optimization Methods and Software} 10(6), 763-781.

\bibitem{tuy}
Tuy, H. (2000). Monotonic optimization: Problems and solution approaches. {\it SIAM Journal on Optimization} 11(2), 464-494.

\bibitem{tuy_survey}
Tuy, H., Al-Khayyal, F. and Thach, P.T. (2005). Monotonic optimization: Branch and cut methods, In {\it Essays and Surveys in Global Optimization}, 39-78. Springer US.

\bibitem{tonosaki}
外崎真造 (2010). 非凸2次制約付き配合計画問題のロバスト最適化, 筑波大学システム情報工学研究科修士学位論文.
