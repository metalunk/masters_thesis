...
\newblock {\it Annals of Operations Research} 98.1-4 (2000), pp.171-187.
...
\newblock {\it Journal of Global Optimization} 24.2 (2002), pp.163-185.

\bibitem{deklerk_survey}
E. de Klerk,
\newblock The complexity of optimizing over a simplex, hypercube or sphere: a short survey,
\newblock {\it Central European Journal of Operations Research} 16.2 (2008), pp.111-125.

\bibitem{deklerk}
E. de Klerk, D. Hertog, and G. Elabwabi,
\newblock On the complexity of optimization over the standard simplex,
\newblock {\it European journal of operational research} 191.3 (2008), pp.773-785.
...
\newblock {\it Theoretical Computer Science} 361.2 (2006), pp.210-225.
...
\newblock {\it Mathematical Programming} 151.2 (2015), pp.433-457.

\bibitem{direct}
D. Jones, C. Perttunen, and B. Stuckman,
\newblock Lipschitzian optimization without the Lipschitz constant,
\newblock {\it Journal of Optimization Theory and Applications} 79.1 (1993), pp.157-181.

\bibitem{pinter}
J. Pint$\acute{\mbox{e}}$r,
\newblock Global Optimization in Action,
\newblock {\it Kluwer Academic Publishers}, Volume 6, (1996).
...
\newblock {\it Simplicial Global Optimization} (2014), pp.61-86.

\bibitem{rubinov}
A. Rubinov, and M. Andramonov,
\newblock Lipschitz programming via increasing convex-along-rays functions,
\newblock {\it Optimization Methods and Software} 10.6 (1999), pp.763-781.

\bibitem{tuy}
H. Tuy,
\newblock Monotonic optimization: Problems and solution approaches,
\newblock {\it SIAM Journal on Optimization} 11.2 (2000), pp.464-494.

\bibitem{tuy_survey}
H. Tuy, F. Al-Khayyal, and P. Thach,
\newblock Monotonic optimization: Branch and cut methods,
\newblock {\it Essays and Surveys in Global Optimization} (2005), pp.39-78.
